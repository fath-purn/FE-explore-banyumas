        ...
        <div className="flex flex-col md:flex-row w-[90%] md:w-[90%] mt-8 gap-5">
          <div className="flex flex-col w-full md:w-[55%]">
            ...
            <div className="mt-10 w-fit">
              <Link
                href={`https://api.whatsapp.com/send?phone=6285155040590&text=Halo!%20Saya%20tertarik%20untuk%20memesan%20kamar%20di%20hotel%20Anda.%20Apakah%20ada%20kamar%20yang%20tersedia%3F`}

...
export default function AddUlasanMakanan(): JSX.Element {
  const [ulasan, setUlasan] = useState(false);
  const [nama, setNama] = useState("");
  const [makananId, setMakananId] = useState<null | number>(null);
  ...
  const handleSubmit = () => {
    ...
    formData.append("makananId", String(makananId));
    ...
    fetch(`${process.env.NEXT_PUBLIC_API_URL}/ulasan`, {
      ...
      .catch((err) => console.log(err));
        ...
        console.log("Error add Ulasan ", error);   
    }
  };

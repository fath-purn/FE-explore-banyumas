...
import { formSubmitHandlerKecamatan } from "@/app/utils/actions";
import Link from "next/link";

export default function LoginForm() {
  const [code, action] = useFormState(formSubmitHandlerKecamatan, undefined);

  return (
    <form action={action} className="space-y-3">
      <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
        <h1 className={`${lusitana.className} mb-3 text-2xl`}>Tambah Kecamatan</h1>
